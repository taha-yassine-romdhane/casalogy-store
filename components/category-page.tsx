              ...
              if (images.length > 0) {
                return images.map((image: string, index: number) => (
                  ...
                  >
                    <Image
                      src={image}
                      alt={`${categoryDisplayName} hero image ${index + 1}`}
                      width={1920}
                      height={1080}
      ...
      <section className="hidden md:block relative">
              ...
              <div className="max-w-4xl mx-auto text-center">
                <h1 className="text-4xl lg:text-6xl font-bold mb-6 text-[#282828]">
                  {categoryDisplayName.split(' ').map((word, index) => 
                    index === categoryDisplayName.split(' ').length - 1 ? 
                ...
                <div className="flex flex-wrap justify-center gap-4 text-sm">
                  {features.map((feature, index) => (
                    <span key={index} className="bg-gray-100 text-gray-700 px-4 py-2 rounded-full border border-gray-200">
                      • {feature}
                    </span>
                  ))}
                </div>
        ...
        <div className="relative grid md:grid-cols-3 bg-white overflow-hidden">
          ...
          <div className="p-8 text-center border-b md:border-b-0 md:border-r border-gray-200">
            ...
            <p className="text-gray-600">Medical-grade materials for professionals</p>
          </div>
          <div className="p-8 text-center border-b md:border-b-0 md:border-r border-gray-200">
            <h3 className="font-bold text-lg mb-2 text-gray-900">Functional Design</h3>
            <p className="text-gray-600">Designed for healthcare professionals</p>
          </div>
          <div className="p-8 text-center">
            <h3 className="font-bold text-lg mb-2 text-gray-900">Perfect Fit</h3>
          ...
          {loading ? (
            ...
            <div className="text-center py-20">
              ...
              <p className="text-gray-500 max-w-md mx-auto">
                We're working hard to bring you the best {categoryDisplayName.toLowerCase()} collection. 
                ...
                <Link href={`/products/${product.slug}`}>
                  <div className={`bg-gray-100 flex items-center justify-center cursor-pointer hover:opacity-90 transition-opacity relative ${viewMode === 'list' ? 'w-32 h-32 rounded-lg flex-shrink-0' : 'aspect-square'}`}>
                    {product.mainImage ? (
                      ...
                      <Icon className={`text-gray-400 ${viewMode === 'list' ? 'w-12 h-12' : 'w-16 h-16'}`} />
                    )}
                  </div>
                </Link>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-[1920px] mx-auto px-4 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-[#282828] mb-4">Why Choose Our {categoryDisplayName}?</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">
                High-quality, medical-grade materials that are durable, comfortable, and easy to maintain.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">
                Thoughtfully designed for healthcare professionals with practical features for long shifts.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">
                Available in extended sizes with options designed for comfort and professional appearance.
              </p>
            </div>
          </div>
        </div>
