...
import { Shirt, Filter, Grid3X3, List, Star, Heart, ShoppingCart, Sparkles, Loader2, Calendar, Play, Users } from 'lucide-react'
...
export default function NewArrivalsPage() {
  ...
  const fetchProducts = async () => {
    try {
      setLoading(true)
      const response = await fetch('/api/products/filtered?newArrivals=true')
  ...
  const allGenders = [...new Set(products.map(product => product.gender).filter(Boolean))]
  ...
  const filteredProducts = products.filter(product => {
    ...
    const genderMatch = !filterGender || product.gender?.toLowerCase() === filterGender.toLowerCase()
    return colorMatch && sizeMatch && genderMatch
  })
      ...
      <section className="relative">
                    ...
                    <>
                      ...
                      {images.map((image: string, index: number) => (
                        ...
                        >
                          <Image
                            src={image}
                            alt={`New arrivals hero image ${index + 1}`}
                            fill
            ...
            <div className="max-w-[1920px] mx-auto px-4 lg:px-8 w-full">
              <div className="max-w-4xl mx-auto text-center">
                ...
                <p className="text-xl mb-8 max-w-2xl mx-auto text-gray-700 leading-relaxed">
                  Discover the latest additions to our medical wear collection. 
                  Fresh styles and innovative designs from the past 5 months, perfect for Tunisia's healthcare professionals.
                </p>
        ...
        <div className="relative grid md:grid-cols-3 bg-white overflow-hidden">
          ...
          <div className="p-8 text-center border-b md:border-b-0 md:border-r border-gray-200">
            <h3 className="font-bold text-lg mb-2 text-gray-900">Latest Designs</h3>
            <p className="text-gray-600">Fresh styles and modern cuts</p>
          </div>
          <div className="p-8 text-center border-b md:border-b-0 md:border-r border-gray-200">
            <h3 className="font-bold text-lg mb-2 text-gray-900">Recently Added</h3>
            <p className="text-gray-600">Products from the past 5 months</p>
          </div>
          <div className="p-8 text-center">
            <h3 className="font-bold text-lg mb-2 text-gray-900">Quality Assured</h3>
            <p className="text-gray-600">Every new arrival meets our high standards</p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-[1920px] mx-auto px-4 lg:px-8">
          {loading ? (
            <div className="flex justify-center items-center py-20">
              ...
              <span className="ml-2 text-gray-600">Loading new arrivals...</span>
            </div>
          ) : error ? (
      ...
      <section className="py-16 bg-white">
        <div className="max-w-[1920px] mx-auto px-4 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-[#282828] mb-4">Fresh & Innovative</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Stay ahead with the latest trends and innovations in medical wear. Our new arrivals bring you the best of comfort, style, and functionality.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="font-bold text-[#282828] mb-2">Latest Designs</h3>
              <p className="text-gray-600 text-sm">
                Fresh styles and modern cuts that reflect current trends in medical apparel.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="font-bold text-[#282828] mb-2">Recently Added</h3>
              <p className="text-gray-600 text-sm">
                All products from the past 5 months, ensuring you get the latest innovations.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="font-bold text-[#282828] mb-2">Quality Assured</h3>
              <p className="text-gray-600 text-sm">
                Every new arrival meets our high standards for comfort, durability, and professional appearance.
              </p>
            </div>
          </div>
        </div>
