...
import { Heart, Filter, Grid3X3, List, Star, ShoppingCart, Shirt, Stethoscope, Thermometer, Cloud, Footprints, Package, Loader2, Play, Users } from 'lucide-react'
...
export default function WomenPage() {
  ...
  const fetchProducts = async () => {
    try {
      setLoading(true)
      const response = await fetch('/api/products/filtered?gender=women')
  ...
  const getCategoryIcon = (category: string) => {
    switch (category) {
      case 'Scrubs': return <Shirt className="w-5 h-5" />
      case 'Lab Coats': return <Stethoscope className="w-5 h-5" />
      case 'Underscrubs': return <Thermometer className="w-5 h-5" />
      case 'Outerwear': return <Cloud className="w-5 h-5" />
  ...
  const getProductIcon = (category: string, listMode: boolean = false) => {
    const iconClass = listMode ? 'w-12 h-12' : 'w-16 h-16'
    switch (category) {
      case 'Scrubs': return <Shirt className={`text-gray-400 ${iconClass}`} />
      case 'Lab Coats': return <Stethoscope className={`text-gray-400 ${iconClass}`} />
      case 'Underscrubs': return <Thermometer className={`text-gray-400 ${iconClass}`} />
      case 'Outerwear': return <Cloud className={`text-gray-400 ${iconClass}`} />
      case 'Footwear': return <Footprints className={`text-gray-400 ${iconClass}`} />
      case 'Accessories': return <Package className={`text-gray-400 ${iconClass}`} />
      default: return <Package className={`text-gray-400 ${iconClass}`} />
    }
  }
      ...
      <section className="hidden md:block relative">
            ...
            <div className="max-w-[1920px] mx-auto px-4 lg:px-8 w-full">
              <div className="max-w-4xl mx-auto text-center">
                <h1 className="text-4xl lg:text-6xl font-bold mb-6 text-[#282828]">
                  Women's Medical <span className="text-blue-600">Wear</span>
                </h1>
                <p className="text-xl mb-8 max-w-2xl mx-auto text-gray-700 leading-relaxed">
                  Professional medical clothing designed specifically for women in healthcare. 
                  Combining functionality, comfort, and feminine style for Tunisia's female medical professionals.
                </p>
        ...
        <div className="relative grid md:grid-cols-3 bg-white overflow-hidden">
          ...
          <div className="p-8 text-center border-b md:border-b-0 md:border-r border-gray-200">
            <h3 className="font-bold text-lg mb-2 text-gray-900">Feminine Fit</h3>
            <p className="text-gray-600">Tailored specifically for women's physique</p>
          </div>
          <div className="p-8 text-center border-b md:border-b-0 md:border-r border-gray-200">
        ...
        <div className="max-w-[1920px] mx-auto px-4 lg:px-8">
          ...
          <div className="mt-4">
            <p className="text-gray-600">
              Showing {filteredProducts.length} of {products.length} women's products
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-[1920px] mx-auto px-4 lg:px-8">
          {loading ? (
            <div className="flex justify-center items-center py-20">
              ...
              <span className="ml-2 text-gray-600">Loading women's products...</span>
            </div>
          ) : error ? (
            ...
            <div className="text-center py-20">
              ...
              <h3 className="text-xl font-semibold text-gray-600 mb-2">No women's products found</h3>
                        ...
                        <div
                          ...
                          style={{
                            backgroundColor: color === 'White' ? '#fff' : 
                                           ...
                                           color === 'Mint' ? '#86efac' :
                                           color === 'Cream' ? '#fef7cd' :
                                           color === 'Rose Gold' ? '#f97316' :
                                           color === 'Silver' ? '#d1d5db' :
                                           color === 'Gold' ? '#fbbf24' :
                                           color === 'Coral' ? '#fb7185' :
                                           color === 'Lavender' ? '#c4b5fd' :
                                           color === 'Nude' ? '#f3e8ff' :
                                           color.includes('Floral') ? '#f9a8d4' : '#6b7280'
                          }}
                        />
                      ))}
      ...
      <section className="py-16 bg-white">
        <div className="max-w-[1920px] mx-auto px-4 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-[#282828] mb-4">Designed for Women in Healthcare</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Every piece in our women's collection is thoughtfully designed to meet the unique needs of female healthcare professionals.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="font-bold text-[#282828] mb-2">Feminine Fit</h3>
              <p className="text-gray-600 text-sm">
                Tailored cuts and fits designed specifically for women's body shapes and preferences.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="font-bold text-[#282828] mb-2">Professional Style</h3>
              <p className="text-gray-600 text-sm">
                Elegant designs that maintain professionalism while expressing personal style.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="font-bold text-[#282828] mb-2">Complete Collection</h3>
              <p className="text-gray-600 text-sm">
                From scrubs to accessories, everything you need for a complete professional wardrobe.
              </p>
            </div>
          </div>
        </div>
