  ...
  return (
    <div className="min-h-screen bg-gray-50">
              ...
              if (images.length > 0) {
                return images.map((image: string, index: number) => (
                  ...
                  >
                    <Image
                      src={image}
                      alt={`Hijebi Scrubs hero image ${index + 1}`}
                      width={1920}
                      height={1080}
      ...
      <section className="hidden md:block relative">
            ...
            <div className="max-w-[1920px] mx-auto px-4 lg:px-8 w-full">
              <div className="max-w-4xl mx-auto text-center">
                <h1 className="text-5xl lg:text-7xl font-bold mb-6 text-[#282828]">
                  Premium <span className="text-blue-600">Hijebi Scrubs</span>
                </h1>
                <p className="text-xl mb-8 max-w-2xl mx-auto text-gray-700">
                  Modest and professional scrubs designed specifically for hijabi healthcare professionals. 
                  Combining comfort, style, and cultural considerations.
                </p>
        ...
        {/* Feature Strips - Hijebi Scrubs Specific */}
        <div className="relative grid md:grid-cols-3 bg-white overflow-hidden">
          ...
          <div className="p-8 text-center border-b md:border-b-0 md:border-r border-gray-200">
            <h3 className="font-bold text-lg mb-2 text-[#282828]">Modest Design</h3>
            <p className="text-gray-700">Thoughtfully designed for hijabi healthcare professionals</p>
          </div>
          <div className="p-8 text-center border-b md:border-b-0 md:border-r border-gray-200">
            <h3 className="font-bold text-lg mb-2 text-[#282828]">Premium Comfort</h3>
            <p className="text-gray-700">Breathable fabrics for all-day comfort</p>
          </div>
          <div className="p-8 text-center">
            <h3 className="font-bold text-lg mb-2 text-[#282828]">Professional Quality</h3>
            <p className="text-gray-700">Medical-grade materials and construction</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-[1920px] mx-auto px-4 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-[#282828] mb-4">Why Choose Our Hijebi Scrubs?</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Specifically designed for hijabi healthcare professionals in Tunisia, combining modesty, comfort, and professional quality.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="font-bold text-[#282828] mb-2">Modest Design</h3>
              <p className="text-gray-600 text-sm">
                Thoughtfully designed with longer sleeves and appropriate coverage for hijabi healthcare professionals.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="font-bold text-[#282828] mb-2">Premium Quality</h3>
              <p className="text-gray-600 text-sm">
                Medical-grade fabrics that are breathable, durable, and easy to maintain for long shifts.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">
                Tailored fit that maintains professional appearance while providing comfort and freedom of movement.
              </p>
            </div>
          </div>
        </div>
